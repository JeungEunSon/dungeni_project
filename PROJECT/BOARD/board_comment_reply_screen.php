                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            $del_yn = $row['del_yn'];
                                ...
                                <?php   } ?>
                                    ...
                                    <tr>
                                        <form name="board_re_comment" method="post" id="board_re_comment" action="/PROJECT/BOARD/board_re_comment_insert.php">
                                            ...
                                            <input type="hidden" name="re_name" value="<?=$user_name?>">
                                            <th class="title">┖&nbsp;&nbsp;<?=$uname?></th>
                                            <td class="bt1" >
                                                <textarea id="reply_comment" name="reply_comment" rows="3" cols="75"></textarea>
                                            </td>
                                            <td class="bt2">
                                                <center>
                                                    <a href="javascript:board_re_comment.submit();" id="re_btn" name="re_btn">답글달기</a>&nbsp;
                                                    <a href="#" id="re_btn_cancl" name="re_btn_cancl" onclick="re_btn_x();">답글취소</a>
                                                    <!-- <button type="submit" id="re_btn" name="re_btn">답글달기</button> -->
                                                </center>
                                            </td>
                                        </form>
                                    </tr>
