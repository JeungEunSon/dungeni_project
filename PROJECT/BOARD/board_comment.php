...
<html>
    ...
    <body style="overflow-y:hidden;">
            <!-- <div id="cmt_title" >
                <div id="title"><a href="#" onclick="board_cmt_show();"><strong>댓글 <?=$cmt_cnt?>개</strong></a></div>
                <td colspan="3"></td>
            </div> -->
            <table cellpadding=15 cellspacing=0>
                ...
                <tbody id="board_cmt_content">
                    <?php
                    if($cmt_cnt != 0) {
                        $sql = "SELECT * FROM board_cmt WHERE b_no='".$_GET['id']."' ORDER BY grp asc,lvl asc,seq desc ";
                        $result = mysqli_query($con,$sql);
                ...
                <tr>
                    <form name="board_comment" method="post" id="board_comment" action="/PROJECT/BOARD/board_comment_insert.php">
                        <input type="hidden" name="b_no" value="<?=$_GET['id']?>">
